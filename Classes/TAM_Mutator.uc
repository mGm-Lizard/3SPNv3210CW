...
defaultproperties
{
    ...
    WeaponInfo(8)=(WeaponName="xWeapons.ShieldGun",Ammo[0]=0,MaxAmmo[0]=1,Ammo[1]=100,MaxAmmo[1]=1)
    ...
    NewNetWeaponClasses(0)=Class'3SPNv3210CW.NewNet_ShockRifle'
    NewNetWeaponClasses(1)=Class'3SPNv3210CW.NewNet_LinkGun'
    NewNetWeaponClasses(2)=Class'3SPNv3210CW.NewNet_MiniGun'
    NewNetWeaponClasses(3)=Class'3SPNv3210CW.NewNet_FlakCannon'
    NewNetWeaponClasses(4)=Class'3SPNv3210CW.NewNet_RocketLauncher'
    NewNetWeaponClasses(5)=Class'3SPNv3210CW.NewNet_SniperRifle'
    NewNetWeaponClasses(6)=Class'3SPNv3210CW.NewNet_BioRifle'
    NewNetWeaponClasses(7)=Class'3SPNv3210CW.NewNet_AssaultRifle'
    NewNetWeaponClasses(8)=Class'3SPNv3210CW.NewNet_ShieldGun'
