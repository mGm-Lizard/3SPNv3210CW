...
static function FillPlayInfo(PlayInfo PI)
{
	...
	PI.AddSetting("3SPN", "bSpawnProtectionOnThaw", "Enable Spawn Protection After Thawing", 0, 500, "Check");
	PI.AddSetting("3SPN", "TeleportOnThaw", "Teleport After Thawing", 0, 501, "Check");
    PI.AddSetting("3SPN", "AutoThawTime", "Automatic Thawing Time", 0, 502, "Text", "3;0:999");
	PI.AddSetting("3SPN", "ThawSpeed", "Touch Thawing Time", 0, 503, "Text", "3;0:999");
	PI.AddSetting("3SPN", "MinHealthOnThaw", "Minimum Health After Thawing", 0, 504, "Text", "3;0:999");
    PI.AddSetting("3SPN", "KillGitters", "Kill Gitters", 0, 505, "Check");
    PI.AddSetting("3SPN", "MaxGitsAllowed", "Max Gits Allowed", 0, 506, "Text", "3;0:999");
}
...
defaultproperties
{
     ...
     TeamAIType(0)=Class'3SPNv3210CW.Freon_TeamAI'
     TeamAIType(1)=Class'3SPNv3210CW.Freon_TeamAI'
     ...
     GameReplicationInfoClass=Class'3SPNv3210CW.Freon_GRI'
     GameName="Freon"
